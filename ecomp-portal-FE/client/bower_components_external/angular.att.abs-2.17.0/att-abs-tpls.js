    ...
    return {
        ...
        link: function (scope, element, attr, ctrl) {
            ...
            radioElm.on('focus', function() {                
                elm.css("outline","thin dotted #333");
...
angular.module('att.abs.tabs', ['att.abs.utilities'])
    ...
    .directive('genericTabs', ['$state',function ($state) {
        return {
            require: '^attTabs',
            restrict: 'EA',
            transclude: false,
...
angular.module("app/scripts/ng_js_att_tpls/popOvers/popOvers.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("app/scripts/ng_js_att_tpls/popOvers/popOvers.html",
    ...
    "                'att-pop-over--bell':popOverPlacement==='bell', \n" +
...
angular.module("app/scripts/ng_js_att_tpls/table/attTableHeader.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("app/scripts/ng_js_att_tpls/table/attTableHeader.html",
    "<th role=\"button\" aria-label=\"column header {{headerName}} {{sortable !== 'false' && '' || 'sortable'}} {{sortPattern !== 'null' && '' || sortPattern}}\" tabindex=\"{{sortable !== 'false' && '0' || '-1'}}\" class=\"tablesorter-header\" ng-class=\"{'tablesorter-headerAsc': sortPattern === 'asc', 'tablesorter-headerDesc': sortPattern === 'desc', 'tablesort-sortable': sortable !== 'false', 'sorter-false': sortable === 'false'}\" att-accessibility-click=\"13,32\" ng-click=\"(sortable !== 'false') && sort();\"><div class=\"tablesorter-header-inner\" ng-transclude></div></th>");
}]);
