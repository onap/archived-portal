...
public class RequestDetailsTest {
	...
	public RequestDetails mockRequestDetails(){
	...
	public void getPolicyNameTest(){
		RequestDetails requestDetails = mockRequestDetails();
		RequestDetails requestDetails1 = new RequestDetails();
		requestDetails1.setPolicyName("test");
		assertEquals(requestDetails.getPolicyName(), requestDetails1.getPolicyName());
	}
